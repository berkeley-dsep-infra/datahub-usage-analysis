...
### Column
```{python}
#| title: "% of clicks recorded every semester"
...
### Column
```{python}
#| title: "Hubs usage categorized by Dates"
...
### Column
```{python}
#| title: "Month by month usage frequency"
#| layout-ncol: 4
...
### Column
```{python}
#| title: "Hubs usage across different times"
...
#| slideshow: {slide_type: ''}
#| tags: []
#| title: "Count of clicks from non github sources across hubs"
...
plt.ylabel('Count')
plt.xticks(rotation = 90)
plt.title('Count of clicks from non github sources across hubs');
...
```{python}
#| title: "Percentage of clicks from non github sources across hubs"
...
```{python}
#| title: "Count of file types from non-Github repositories"
...
plt.xlabel('File Type')
plt.ylabel('Counts')
plt.title('Count of file types from non-Github repositories');
```
### Column
```{python}
#| title: "Clicks from non Github repositories categorized by semester"
# filetypes across hubs
...
```{python}
#| title: "Count of clicks from different course repositories"
